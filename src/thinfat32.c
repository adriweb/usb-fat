...
#define PRINTF_INT8(b) \
    ...
    ((((uint32_t)(b)) & 0x40u) ? '1' : '0'), \
    ((((uint32_t)(b)) & 0x20u) ? '1' : '0'), \
    ((((uint32_t)(b)) & 0x10u) ? '1' : '0'), \
    ((((uint32_t)(b)) & 0x08u) ? '1' : '0'), \
    ((((uint32_t)(b)) & 0x04u) ? '1' : '0'), \
    ((((uint32_t)(b)) & 0x02u) ? '1' : '0'), \
    ((((uint32_t)(b)) & 0x01u) ? '1' : '0')

static char debug_buffer[250];

// USERLAND
int read_sector(uint8_t *data, uint32_t blocknum) {
    /*sprintf(debug_buffer, "ar: 0x%02X%02X%02X%02X",
        (uint8_t)(blocknum >> 24),
        (uint8_t)(blocknum >> 16),
        (uint8_t)(blocknum >> 8),
        (uint8_t)(blocknum >> 0));
...
int write_sector(uint8_t *data, uint32_t blocknum) {
    /*sprintf(debug_buffer, "aw: 0x%02X%02X%02X%02X",
        (uint8_t)(blocknum >> 24),
        (uint8_t)(blocknum >> 16),
        (uint8_t)(blocknum >> 8),
        (uint8_t)(blocknum >> 0));
...
*/
uint32_t tf_get_open_handles(void)
{
    int i;
    TFFile *fp;
    uint32_t retval = 0;
